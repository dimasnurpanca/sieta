...
public class MegaOrganizerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mega_organizer);
    ...
    public void direct(View v){
        startActivity(new Intent(getApplicationContext(), MegaOrganizerDetailActivity.class));
    }

    public void direct2(View v){
        // Get Current Date
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(MegaOrganizerActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
