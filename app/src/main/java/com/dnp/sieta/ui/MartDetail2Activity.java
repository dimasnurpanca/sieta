...
public class MartDetail2Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mart_detail2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(MartDetail2Activity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
