...
// Create an ArrayAdapter using the string array and a default spinner
    ...
    public void direct(View v){
        startActivity(new Intent(getApplicationContext(), OrderDetailPengirimanActivity.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(OrderDetailActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
