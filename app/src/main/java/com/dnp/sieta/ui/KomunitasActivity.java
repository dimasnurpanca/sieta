...
public class KomunitasActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void direct(View v){
        startActivity(new Intent(getApplicationContext(), KomunitasDetailActivity.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(KomunitasActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
