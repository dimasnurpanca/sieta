...
public class MartDetailActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void direct(View v){
        startActivity(new Intent(getApplicationContext(), MartDetail2Activity.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(MartDetailActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
