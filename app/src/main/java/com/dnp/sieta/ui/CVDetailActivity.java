...
public class CVDetailActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void direct(View v){
        startActivity(new Intent(getApplicationContext(), CVDetail2Activity.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(CVDetailActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
