...
public class MegaConsultationDownlineActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_megaconsultationdownline);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(MegaConsultationDownlineActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
