...
public class CallingActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void direct(View v){
        startActivity(new Intent(getApplicationContext(), CallingDetailActivity.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(CallingActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
