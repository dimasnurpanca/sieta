...
public class MegaConsultationDownlineDetailActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_megaconsultationdownline_detail);
    ...
    public void direct(View v){
        startActivity(new Intent(getApplicationContext(), MegaConsultationDownlineDetail2Activity.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(MegaConsultationDownlineDetailActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
