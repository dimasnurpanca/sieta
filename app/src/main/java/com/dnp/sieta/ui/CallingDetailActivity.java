...
public class CallingDetailActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(CallingDetailActivity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
