...
public class CVDetail2Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cv_detail2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Toast.makeText(CVDetail2Activity.this, "Fitur ini belum tersedia", Toast.LENGTH_LONG).show();
            return true;
        }
    ...
    public void onBackPressed() {
        startActivity(new Intent(getApplicationContext(), CVDetailActivity.class));
        finish();
    }
